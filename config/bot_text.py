...
@dataclass
class Text:
    welcome: str = "✅ <b>Добро пожаловать в HiddenCoin!</b>\n" \
                   "➡️ <b>Здесь ты можешь поднять денег абсолютно без вложений</b>\n" \
    ...
    earn: str = "🔥 <i>Ты можешь получить деньги за:</i>\n\n" \
                "\t➖ <b>Кликер</b>\n" \
    ...
    invite: str = f"💰 За каждого приглашенного человека ты будешь получать <b>{balance_for_referral} {money_name}!</b>\n\n" \
                  f"💥 Рекламировать ссылку можно в чатах или же просто отправить ее друзьям!\n\n" \
